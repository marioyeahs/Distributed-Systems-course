...
public class EchoServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            // abro el socket para el servidor ( para que este a la escucha) en el puerto
            // 1007
            serverSocket = new ServerSocket(8000);
        } catch (IOException e) {
            System.out.println(myURL + ": no puedo escuchar en el puerto: 8000, " + e.toString());
            System.exit(1);
        }
        System.out.println(myURL + ": EchoServer esta escuchando en el  puerto: 8000");
        ...
        try {
            ...
            while (listening) // bucle infinito
            {
                ...
                while ((inputline = is.readLine()) != null) {
                    ...
                    // System.out.println("Cantidad: " + parts[0] + "\nTarjeta: " + parts[1] +
                    // "\nCVV: " + parts[2]);
                    os.println(eo.pago(parts[0], parts[1], parts[2], parts[3]));// escribimos en el socket lo recibido
                                                                                // mas mensaje
