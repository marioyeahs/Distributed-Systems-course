...
public class EchoObjectStub implements EchoInterface {
    ...
    public int pago(String cantidad_a_pagar, String tarjeta, String cvv, String total) throws java.rmi.RemoteException {
        int output = 0;
        try {
            connect();
        ...
        if (echoSocket != null && os != null && is != null) {
            try {
                ...
                String datos = " ";
                datos = cantidad_a_pagar + " " + tarjeta + " " + cvv + " " + total;
                os.println(datos);// escribe en el socket
